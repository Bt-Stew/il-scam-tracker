...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '--bbbst-offwhite:#EBEADA;--bbbst-pale:#E8F2FF;--bbbst-panel-bg:#F4F6FA;--bbbst-card-bg:#FFFFFF;'
      ...
      + 'background:var(--bbbst-panel-bg);border:1px solid var(--bbbst-border);border-radius:18px;'
      + 'padding:20px 22px 18px;box-shadow:0 2px 14px rgba(3,33,96,0.09);}'
      + '.bbbst-widget *{box-sizing:border-box;}'
      + '.bbbst-widget.bbbst-dark{--bbbst-panel-bg:#081221;--bbbst-card-bg:#0f1d33;--bbbst-text:#f2f4f8;--bbbst-muted:#aeb8c9;--bbbst-border:#233150;--bbbst-pale:#122a4d;}'
